...
export const SEARCH_LOCATIONS: SearchLocation[] = [
    {
        ...
        canonicalLocation: 'San Francisco,California,United States',
        countryCode: 'US',
        languageCode: 'en',
    },
    ...
    { displayName: 'Cairo', canonicalLocation: 'Cairo,Cairo Governorate,Egypt', countryCode: 'EG', languageCode: 'ar' },
    {
        ...
        canonicalLocation: 'Cape Town,Western Cape,South Africa',
        countryCode: 'ZA',
        languageCode: 'af',
    },
    {
        displayName: 'London',
        canonicalLocation: 'Greater London,England,United Kingdom',
        countryCode: 'GB',
        languageCode: 'en',
    },
    {
        displayName: 'Nairobi',
        canonicalLocation: 'Nairobi,Nairobi County,Kenya',
        countryCode: 'KE',
        languageCode: 'sw',
    },
    { displayName: 'New Delhi', canonicalLocation: 'New Delhi,Delhi,India', countryCode: 'IN', languageCode: 'hi' },
    {
        ...
        canonicalLocation: 'New York,New York,United States',
        countryCode: 'US',
        languageCode: 'en',
    },
    {
        displayName: 'Paris',
        canonicalLocation: 'Paris,Paris,Ile-de-France,France',
        countryCode: 'FR',
        languageCode: 'fr',
    },
    {
        displayName: 'Rio de Janeiro',
        canonicalLocation: 'Rio de Janeiro,State of Rio de Janeiro,Brazil',
        countryCode: 'BR',
        languageCode: 'pt',
    },
    {
        displayName: 'Sydney',
        canonicalLocation: 'Sydney CBD,New South Wales,Australia',
        countryCode: 'AU',
        languageCode: 'en',
    },
